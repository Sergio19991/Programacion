...
public class CuentaCorriente {
    ...
    com.sergiobejaranoarroyo.Banco banco;   //ACTIVIDAD 6
    ...
    CuentaCorriente(String nombre, String dni, com.sergiobejaranoarroyo.Banco banco) {
        this(0, dni, -50);
        this.nombre = nombre;
        this.banco = banco;
    }

    void cambiarBanco(com.sergiobejaranoarroyo.Banco banco) {
        this.banco = banco;
    }
